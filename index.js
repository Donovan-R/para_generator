...
// const textHtml = (text) => text.map((text) => text);
// console.log(textHtml);

const submit = document.getElementById("submit");
const paragraphes = document.querySelector(".paragraphes");
...
submit.addEventListener("click", function (e) {
  ...
  if (number > 0 && number < 10) {
    paragraphes.innerHTML = newText
      .map((para) => `<p class="newPara"> ${para}</p>`)
      .join("");
  } else {
    paragraphes.innerHTML = `<p class="newPara"> ${
